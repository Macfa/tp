...
?>
    ...
    <script type="text/javascript">
        ...
        {
            var RetVal = false;
            console.log('13123231232312312313');
            /* Payplus Plugin 실행 */
...
<div class="wrap order-wrap center">
	<form method="post" action="/Test_sample/pp_cli_hub.php" id="order-form" name="order_info">
 ...
 -->
		...
		<section class="section-no-padding txt-left js-addressWrap">
			<section class="js-addressDetail address-detail active">
				<label class="inp-wrap-full">
					<input type="text" value=<?php echo number_format($mb['mbPoint']) ?> class="inp-txt js-address">
					<input type="text" value=<?php echo number_format($mb['mbPoint']-$value['gfPoint'])
					 ?> class="inp-txt js-address">
					<div class="inp-label">사용할 포인트 / 현금 결제금액 <span class="inp-required">필수</span></div>
				</label>
				<br/>
			</section>
		</section>
...
<!-- 	    <div id="display_setup_message" style="display:none">
	...
	?>
		...
		<input type="hidden" name="good_mny" class="w100" value="<?php echo $totalPoint ?>" maxlength="9"/>
