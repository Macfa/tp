...
<div class="wrap <?php echo $_GET['id']?>-container">
	...
	<input type="hidden" class="js-capacity js-planCalcArg" name="capacity" value="<?php echo $selectedCapacity?>"/>
	<?php endif?>
	<?php if ($arrApplyTypeCnt == 1) :?>
	<input type="hidden" class="js-applyType js-planCalcArg" name="applyType" value="<?php echo $applyTypeDefaultKey?>"/>
	<?php endif?>
	<?php if ($isNotSupportSelPlanDc === true) :?>
	<input type="hidden" class="js-dcType js-planCalcArg" name="discountType" value="support"/>
	<?php endif?>
				...
				<div class="row">
					<div class="col-tit">
						...
						<div class="col-2 radio">
							<label class="inp-radio">
								<input class="js-planCalcArg" type="radio" name="discountType" value="support" data-point="5000"/>
								<div class="inp-radio-btn"></div>
							...
							<label class="inp-radio">
								<input class="js-planCalcArg" type="radio" name="discountType" value="selectPlan" data-point="7000"/>
								<div class="inp-radio-btn"></div>
				...
				<div class="row">
					<div class="col-tit">
						...
						<?php foreach($arrApplyType as $key => $val) :?><div class="col-<?php echo count($arrApplyType)?> radio">
							<label class="inp-radio">
								<input class="js-planCalcArg" type="radio" name="applyType" value="<?php echo $key?>" data-point="<?php echo 5000*$key?>" />
								<div class="inp-radio-btn"></div>
	...
	<section>
		<div class="vacance_bar <?php echo $detailNone ?>">
			<div class="pc_img">
				<img src="<?=PATH_IMG?>/bar_event_pc.jpg">
			</div>
			<div class="mobile_img">
				<img src="<?=PATH_IMG?>/bar_event_mobile.jpg">
			</div>
			<div class="tablet_img">
				<img src="<?=PATH_IMG?>/bar_event-tablet.jpg">
			</div>
			<div class="landscape_img">
				<img src="<?=PATH_IMG?>/bar_event-landscape.jpg">
			</div>
		</div>
	</section>
	...
	<?php 
	require_once(PATH_PRD."/dev-giftList.inc.php");	
	?>
	<?php
