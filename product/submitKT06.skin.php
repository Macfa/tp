			...
			<div class="lpu_explan" >
				<table class="sty_01" style="width:100%">
					...
					<tr>
						...
						<td class="cont">
							<input type="text"  class="inp" style="width:105px;" name="BaseRegno1" id="BaseRegno1" value=""onkeydown="return keyEventCtrl('no',event,this);" onkeyup="javascript:fnNext(event,8,this,BaseSexInfo);" maxlength="8" />
							<input type="hidden" name="BaseRegno2">
							<select id="BaseSexInfo" name="BaseSexInfo">
		...
		<div class="lpu_explan" >
				...
				<table class="sty_01" style="width:100%;">
					...
					<tr>
						<td class="tit">생년월일(8자리)</td>
						<td class="cont">
							<input type="tel"  class="inp" style="width:105px;" name="teenBaseRegno1" onKeyUp="javascript:fnNext(event,8,this,teenBaseSexInfo);" maxlength="8"/>
							<input type="hidden" name="teenBaseRegno2">
							<select id="teenBaseSexInfo" name="teenBaseSexInfo">
								<option value="">성별</option>
								<option value="M">남</option>
								<option value="F">여</option>
							</select>
