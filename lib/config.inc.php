...
$cfg['loginURLPrefix'] = $cfg['url']."/user/login.php?returnURL=";
$cfg['login_url'] = $cfg['loginURLPrefix'].urlencode($cfg['current_url']);

if($_SERVER["HTTP_HOST"] !== 'tplanit.co.kr' || $cfg['ip'] === '222.108.18.132' || $cfg['ip'] === '59.15.33.238')
	$cfg['isDev'] = true;
