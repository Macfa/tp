...
<?
    ...
    include "/home/www/tplanit/develop/_chy/cfg/site_conf_inc.php";
...
<?
    ...
    /* = -------------------------------------------------------------------------- = */
?>
    <script type="text/javascript" src="/js/lib/jquery.js?v=1477642750"></script>
...
?>
    <script type="text/javascript">
        ...
        {
            var RetVal = false;
            console.log(MakePayMessage( form ));
            /* Payplus Plugin 실행 */
...
<?
    ...
    /* = -------------------------------------------------------------------------- = */
?>
                    <h1>[결제요청] <span> 이 페이지는 hy가 관리하는 페이지입니다.</span></h1>
                    <!-- 상단 문구 -->
                    <div class="sample">
                            <p>이 페이지는 결제를 요청하는 페이지입니다.<br />
                            결제를 위한 Payplus Plug-in이 고객의 PC에 설치되어 있는지 확인합니다.<br /><br />
...
?>
                   ...
                   <!-- 상품명(good_name) -->
                    <tr>
                        <th>상품명</th>
                        <td><input type="text" name="good_name" class="w100" value="<?php echo $gifts ?>"/></td>
                    </tr>
                    <!-- 결제금액(good_mny) - ※ 필수 : 값 설정시 ,(콤마)를 제외한 숫자만 입력하여 주십시오. -->
                    <tr>
                        <th>결제 금액</th> 
                        <td><input type="text" name="good_mny" class="w100" value="<?php echo $totalPoint ?>" maxlength="9"/>원(숫자만 입력)</td>
                    </tr>
                    <!-- 주문자명(buyr_name) -->
                    <tr>
                        <th>주문자명</th>
                        <td><input type="text" name="buyr_name" class="w100" value="<?php echo $_POST['arName'] ?>"/></td>
                    </tr>
                    <!-- 주문자 E-mail(buyr_mail) -->
                    <tr>
                        <th>E-mail</th> 
                        <td><input type="text" name="buyr_mail" class="w200" value="<?php echo $mb['mbEmail'] ?>" maxlength="30" /></td>
                    </tr>
                    <!-- 주문자 연락처1(buyr_tel1) -->
                    <tr>
                        <th>전화번호</th>
                        <td><input type="text" name="buyr_tel1" class="w100" value="<?php echo $_POST['arTel'] ?>"/></td>
                    </tr>
                    <!-- 휴대폰번호(buyr_tel2) -->
                    <tr>
                        <th>휴대폰번호</th>
                        <td><input type="text" name="buyr_tel2" class="w100" value="<?php echo $_POST['arPhone'] ?>"/></td>
                    </tr>
                    </table>
...
<!--    made by hy  that use variable in pp_cli_hub.php -->
    <input type="hidden" name="c_PayPlus_value" value="<?php echo $totalPoint; ?>">
