<div class="wrap myspace-wrap">
	...
	<ul class="myspace-list-group">
		...
		<li class="myspace-list-wrap"><a href="applyStateList.php" class="myspace-list">핸드폰 신청내역</a></li>
	</ul>
	<div class="clear"></div>
	<br/>
	<?if (count($applyExist) > 0 ) : // 일반구매 신청현황?> 
	<?foreach ($deviceTit as $key => $value) :?>
		<div class="myspace-preorder">
			<a href="/user/applyState.php?dvId=<?echo $value?>&dvKey=<?echo $dvKey[$key]?>" class="preorderLink productBanner">
				<?echo $key?> 신청현황
			</a>
		</div>
		<br/>		
