...
$existList = DB::query("SELECT * FROM tmPointHistory WHERE phDate >= %s AND mbEmail !='admin@naver.com' ANd mbEmail !='kies13@naver.com'ANd mbEmail !='kizunamj@traum.asia' AND mbEmail != 'traumcorp@gmail.com' AND mbEmail !='hdhcoss1@naver.com' AND mbEmail !='terracanjeep@nate.com' AND mbEmail !='crepubic@naver.com' ", $cutline);
