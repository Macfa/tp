<form method="post" action="addNewsListModifyAction.php" enctype="multipart/form-data">
	...
	<div class="wrap">
		...
		<h2 class="center">일일조회수</h2>
		<table class="table dailyhit">
			<thead>				
				<tr>		
					<td class="center">리스트날짜</td>					
					<td class="center">일일조회수</td>					
				</tr>
			</thead>
			<tbody>
			<?php foreach ($arrDailyHit as $val) :?>
			<tr>
				<td class="center"><?php echo $val['ndDay']?></td>				
				<td class="center"><?php echo $val['ndHit']?></td>
			</tr>
			<?php endforeach?>
			</tbody>
			</table>
