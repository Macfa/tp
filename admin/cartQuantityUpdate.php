...
try
{
	if (isNullVal($_GET['quantity']) || isNum($_GET['quantity']) === false)
		throw new Exception('수량이 숫자가 아니거나 빈 값입니다.', 3);
...
DB::update("tmCart", array('caQuantity' => $_GET['quantity']),"caKey = %i and mbEmail = %s", $_GET['id'], $mb['mbEmail']);
echo true;
?>